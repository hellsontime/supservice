...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\TicketStatusController' => 'getTicketStatusControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Event'.\DIRECTORY_SEPARATOR.'EnsureMessageBelongsToTicket.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Event'.\DIRECTORY_SEPARATOR.'EnsureTicketBelongsToUser.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageRepositoryInterface.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TicketRepositoryInterface.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TicketRepository.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\Event\\EnsureMessageBelongsToTicket'] ?? $this->getEnsureMessageBelongsToTicketService());
        }, 1 => 'onKernelRequest'], -10);
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\\Event\\EnsureTicketBelongsToUser'] ?? $this->getEnsureTicketBelongsToUserService());
        }, 1 => 'onKernelRequest'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private 'App\Event\EnsureMessageBelongsToTicket' shared autowired service.
     *
     * @return \App\Event\EnsureMessageBelongsToTicket
     */
    protected function getEnsureMessageBelongsToTicketService()
    {
        return $this->privates['App\\Event\\EnsureMessageBelongsToTicket'] = new \App\Event\EnsureMessageBelongsToTicket(($this->privates['App\\Repository\\MessageRepository'] ?? $this->getMessageRepositoryService()));
    }

    /**
     * Gets the private 'App\Event\EnsureTicketBelongsToUser' shared autowired service.
     *
     * @return \App\Event\EnsureTicketBelongsToUser
     */
    protected function getEnsureTicketBelongsToUserService()
    {
        return $this->privates['App\\Event\\EnsureTicketBelongsToUser'] = new \App\Event\EnsureTicketBelongsToUser(($this->privates['security.helper'] ?? $this->getSecurity_HelperService()), ($this->privates['App\\Repository\\TicketRepository'] ?? $this->getTicketRepositoryService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Z9jozAulIR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.fPFDSMP'] ?? $this->get_ServiceLocator_FPFDSMPService()), new RewindableGenerator(function () {
